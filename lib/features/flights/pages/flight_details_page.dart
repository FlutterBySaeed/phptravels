...
class _FlightDetailsPageState extends State<FlightDetailsPage> {
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          // Single container for all booking options
          Container(
            decoration: BoxDecoration(
            ...
            child: Column(
              children: [
                ..._bookingOptions.asMap().entries.map((entry) {
                  final index = entry.key;
                  final option = entry.value;
                  final isLast = index == _bookingOptions.length - 1;

                  return Column(
                    children: [
                      _buildBookingOptionItem(context, option),
                      if (!isLast)
                        Container(
                          height: 1,
                          color: Theme.of(context).dividerColor,
  ...
  Widget _buildBookingOptionItem(BuildContext context, BookingOption option) {
    return Container(
      padding: const EdgeInsets.all(16),
      child: Row(
        children: [
          ...
          Container(
            ...
            child: Center(
              child: Text(
                option.providerName.substring(0, 1),
            ...
            children: [
              Consumer<CurrencyProvider>(
                builder: (context, currencyProvider, child) {
                  return Text(
                    currencyProvider.formatPrice(option.rawPricePKR,
                        compact: true),
                    style: Theme.of(context).textTheme.bodyMedium?.copyWith(
                          fontWeight: FontWeight.w700,
                          fontSize: 14,
